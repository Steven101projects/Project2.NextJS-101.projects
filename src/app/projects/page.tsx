...
export default function Projects() {
  // Array of quotes
  const quotes = [
    { text: "Every brushstroke is a step toward mastery.", author: "Nikola Tesla" },
  ...
  // Pick a random quote each time the component loads
  const randomQuote = quotes[Math.floor(Math.random() * quotes.length)];

  return (
    <div>
      <ProjectHeader />
      <div id="quoteBlock" className="relative flex justify-center items-center mt-6">
        {/* Image */}
        <img
          src="quotes.jpg"
          className="w-[55vw] h-[45vh] object-cover shadow-md rounded-md"
          alt="Quote Block"
        />

        {/* Centered quote text overlay */}
